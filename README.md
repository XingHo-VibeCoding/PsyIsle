...
- **安全底线**：不提供医疗诊断与治疗、不宣称疗效、不诱导自诊；每页均有危机资源入口（12356 全国统一心理援助热线）
...
| Day 4（二版） | PRD v2.0：目标用户收紧为「有情绪困扰/心境障碍的大学生」，新增认知纠正功能与安全合规硬门槛 → `PRD.md` | ✅ 已完成 |
| Day 4（三版） | PRD v3.0：与 research.md 差异上桌、18 个单日任务拆解、清空泛表述 → `PRD.md` | ✅ 已完成 |
| Day 5 | 技术选型（含量表选定 + 自评条目定稿） | 待做 |
| Day 7 | 网站 MVP 动工：T1 骨架 + T2 危机页 + T3 首页 | 待做 |
| Day 8-9 | 测评主功能（T6-T8） | 待做 |
| Day 10-13 | 自评 + 安慰卡 + 呼吸练习（T4、T5、T9、T10） | 待做 |
| Day 14-15 | 认知纠正（T11、T12） | 待做 |
| Day 16-18 | 知识库 4 篇 + 关于页（T13-T16） | 待做 |
| Day 19-20 | 打磨 + 合规自查 + 部署上线（T17、T18） | 待做 |
...
├── PRD.md              # 产品需求文档（Day 4，v3.0）：9 个 P0 功能 + 11 个页面 + 7 个数据字段 + 18 个单日任务 + 安全合规硬门槛
├── PRD-自检报告.md     # 按验收标准的 AI 自检结论（Day 4，v3.0）
