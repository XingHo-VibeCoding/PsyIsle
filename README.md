...
| Day 7-8 | 网站 MVP 动工：T1 骨架 + T2 危机页 + **T2b 地区热线核实** + T3 首页 | 待做 |
| Day 9-11 | 大五测评主功能（T6-T9） | 待做 |
| Day 12-14 | 自我探索测评群（T10a、T10b、T11） | 待做 |
| Day 15-17 | 自评 + 安慰卡 + 呼吸练习（T4、T5、T12、T13） | 待做 |
| Day 18-19 | 认知纠正（T14、T15） | 待做 |
| Day 20-22 | 知识库 4 篇 + 关于页（T16-T19） | 待做 |
| Day 23-25 | 打磨 + 合规自查 + 部署上线（T20-T22） | 待做 |

> ✅ **排期已定案（2026-09-22）：路线 A · 25 天。** 共 **24 个单日任务**（比原 23 个多出 T2b——地区热线清单的逐条核实与录入）。若进度落后，按 `PRD.md` 第 11.3 节顺序砍，**第一刀砍 T5 呼吸练习**。
...
├── PRD.md              # 产品需求文档（Day 4，v4.0）：13 个 P0 功能 + 5 个测评 + 13 个页面 + 9 个数据字段 + 24 个单日任务 + 路线 A（25 天）
