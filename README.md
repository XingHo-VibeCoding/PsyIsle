...
| Day 8-10 | 大五测评主功能（T6-T9） | 待做 |
| Day 11-13 | 自我探索测评群（T10a、T10b、T11） | 待做 |
| Day 14-16 | 自评 + 安慰卡 + 呼吸练习（T4、T5、T12、T13） | 待做 |
| Day 17-18 | 认知纠正（T14、T15） | 待做 |
| Day 19-21 | 知识库 4 篇 + 关于页（T16-T19） | 待做 |
| Day 22-25 | 打磨 + 合规自查 + 部署上线（T20-T22） | 待做 |

> ⚠️ **排期提示**：扩充测评后共 **23 个单日任务**，**20 天装不下**。走 25 天（路线 A，推荐）或按 `PRD.md` 第 11.3 节顺序砍（路线 B，第一刀砍呼吸练习）。
...
├── PRD.md              # 产品需求文档（Day 4，v4.0）：13 个 P0 功能 + 5 个测评 + 13 个页面 + 9 个数据字段 + 23 个单日任务
