...
- **测评**：大五人格（IPIP-NEO-120，含 30 侧面）+ 自我价值感 + 自我效能感 + 思考风格 + 情绪自评，**全部免费出完整结果，不用登录**
...
| Day 11-12 | 自我探索测评群（T10、T11） | 待做 |
| Day 13-15 | 自评 + 安慰卡 + 呼吸练习（T4、T5、T12、T13） | 待做 |
| Day 16-17 | 认知纠正（T14、T15） | 待做 |
| Day 18-20 | 知识库 4 篇 + 关于页（T16-T19） | 待做 |
| Day 21-24 | 打磨 + 合规自查 + 部署上线（T20-T22） | 待做 |

> ⚠️ **排期提示**：扩充测评后共 22 个单日任务，**20 天装不下**。走 24 天（路线 A，推荐）或按 `PRD.md` 第 11.3 节顺序砍（路线 B，第一刀砍呼吸练习）。
...
├── PRD.md              # 产品需求文档（Day 4，v4.0）：13 个 P0 功能 + 5 个测评 + 13 个页面 + 9 个数据字段 + 22 个单日任务
